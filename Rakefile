namespace :kenglish do
  desc "Given a directory, find all mp3 files that do not have a 'year' field"
  task :find_missing_years do
    puts "find_missing_years"
...
#   track = i + 1
#   new_title = "#{sprintf('%03d', track)} - Master of Senate"
